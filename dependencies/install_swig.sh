...
./configure --host=x86_64 --build=x86_64 --target=x86_64 --prefix=/glade/u/home/rlong/opt/bt2 --enable-python-bindings --enable-python-plugins --disable-man-pages --disable-debug-info --disable-shared
make
make install
cd ..

export PYTHONPATH=$PYTHONPATH:/glade/u/home/rlong/opt/bt2/lib/python3.7/site-packages
