...
setup(
    ...
    description="ESMF Profiler",  # Optional
    ...
    url="https://github.com/esmf-org/esmf-profiler",  # Optional
    ...
    entry_points={  # Optional
        "console_scripts": [
            "esmf-profiler=esmf_profiler.main:main",
        ],
    },
