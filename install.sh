...
echo "setenv PYTHONPATH $PYTHONPATH:$BT2PYTHON" >> ./venv/bin/activate.csh
...
echo "setenv LD_LIBRARY_PATH $LD_LIBRARY_PATH:$PWD/dependencies/INSTALL/$BT2/lib" >> ./venv/bin/activate.csh
